      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 text-left">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7 space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-neo-navy">
              Who We Are
            </h2>
            <p className="text-sm md:text-base text-neo-muted leading-relaxed">
          ...
          <div className="lg:col-span-5 bg-neo-ice p-8 rounded-3xl border border-neo-clinical/20 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h3 className="font-bold text-neo-navy text-lg">
                Core Clinic Pillars
              </h3>
            </div>
            <div className="space-y-3 text-xs md:text-sm text-neo-dark">
        ...
        <div className="bg-neo-ice rounded-3xl p-8 md:p-12 border border-neo-clinical/20 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-2">
              <ShieldCheck className="w-5 h-5 text-neo-clinical mb-2" />
              <h3 className="font-bold text-neo-navy text-base">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-2">
              <Sparkles className="w-5 h-5 text-neo-navy mb-2" />
              <h3 className="font-bold text-neo-navy text-base">
        ...
        <div className="bg-white p-8 md:p-12 rounded-3xl border border-neo-clinical/25 shadow-card space-y-6">
          <h2 className="text-2xl font-bold text-neo-navy">
